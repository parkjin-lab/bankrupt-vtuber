...
- **판정 스탬프** — 라이브 **PERFECT** / **GOOD** 가 `Art/judge_perfect` 금 스탬프 · `Art/judge_good` 흰 스탬프 (크기 차이 · SFX · Perfect 웹캠 펀치·히트창 그대로. Miss는 빨간 글자)
