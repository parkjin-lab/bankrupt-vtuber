...
- **영수증** — 타이틀 **이어서 하기** 현금 · 아침 **현금** · 라이브 **지금 수입** · 정산 **오늘 수입** / **남은 현금** 이 같은 `Art/cash_slip` (모자라면 경고 빨강 + **청구보다 부족**. 세이브 없으면 로비 영수증 숨김. 카운트·+₩·고지서·숫자·라우팅은 그대로)
