...
- **고지서** — 아침 **오늘 청구** · 라이브 **청구** · 정산 **부채** 가 같은 `Art/bill_notice` (늘면 빨강 카운트. 숫자·라우팅은 그대로)
