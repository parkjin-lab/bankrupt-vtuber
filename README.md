...
- **콤보 배지** — 라이브 **COMBO** 가 `Art/combo_plate` 스트림 오버레이 배지 (1.15 팝 · 5+는 1.22 · **콤보 끊김**/SFX·규칙 그대로)
