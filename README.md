...
- **돈 스탬프 · 팝 슬립** — 이미 붙은 머니 피드백만 모은다(숫자·경제·청구 수식은 그대로).
  ...
  - `Art/bill_cover` — 라이브 **청구 커버** 금색 PAID 슬램(`sfx_bill_cover`, 한 판 한 번) · 클리어 **청구 커버**(파산은 숨김)
