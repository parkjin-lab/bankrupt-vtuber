...
- **패드 / 채팅 / 노트** — `Art/pad_*` · `Art/title_start` / `Art/title_continue`(타이틀 **새 방송 시작** / **이어서 하기** 키캡, `sfx_title`) · `Art/golive_key`(아침 **방송 켜기** / **콘서트 방송** 키캡, `sfx_golive`) · `Art/nextday_key`(정산 **다음날** 키캡, `sfx_nextday`) · `Art/chat_bubble` · `Art/note_chip` · `Art/superchat_chip` 금 봉투 · `Art/hit_rail`
