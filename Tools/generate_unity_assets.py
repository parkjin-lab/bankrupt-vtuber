...
""",
    ...
    week2_guid = guid_for("Assets/Scripts/Data/Week2Balance.cs")
    write(
        ROOT / "Assets/Resources/Balance/Week2Balance.asset",
        f"""%YAML 1.1
%TAG !u! tag:unity3d.com,2011:
--- !u!114 &11400000
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {{fileID: 11500000, guid: {week2_guid}, type: 3}}
  m_Name: Week2Balance
...
""",
    ...
    write(
        ROOT / "Assets/Resources/Balance/Week2Balance.asset.meta",
        native_meta(guid_for("Assets/Resources/Balance/Week2Balance.asset")),
    )

    week3_guid = guid_for("Assets/Scripts/Data/Week3Balance.cs")
    write(
        ROOT / "Assets/Resources/Balance/Week3Balance.asset",
        f"""%YAML 1.1
%TAG !u! tag:unity3d.com,2011:
--- !u!114 &11400000
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {{fileID: 11500000, guid: {week3_guid}, type: 3}}
  m_Name: Week3Balance
  m_EditorClassIdentifier: BankruptVtuber.Week3Balance
  firstDay: 11
  lastDay: 15
  bankruptDebt: 260000
  winDebtMax: 15000
  ...
  goodsPrice: 7000
  goodsSoldMembersFactor: 0.4
  goodsSoldPeakFactor: 0.08
  goodsSoldMin: 1
  goodsPromoMultiplier: 1.5
  promoWindowSeconds: 1.2
  promoFallbackSeconds: 55
  extraThreats:
  - id: gear_break
    displayName: 장비 고장
    minWon: 6000
...
""",
    ...
    write(
        ROOT / "Assets/Resources/Balance/Week3Balance.asset.meta",
...
""",
    ...
    week5_guid = guid_for("Assets/Scripts/Data/Week5Balance.cs")
    write(
        ROOT / "Assets/Resources/Balance/Week5Balance.asset",
        f"""%YAML 1.1
%TAG !u! tag:unity3d.com,2011:
--- !u!114 &11400000
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {{fileID: 11500000, guid: {week5_guid}, type: 3}}
  m_Name: Week5Balance
  m_EditorClassIdentifier: BankruptVtuber.Week5Balance
  firstDay: 21
  lastDay: 25
  bankruptDebt: 350000
  billRent: 15000
...
""",
    ...
    write(
        ROOT / "Assets/Resources/Balance/Week5Balance.asset.meta",
