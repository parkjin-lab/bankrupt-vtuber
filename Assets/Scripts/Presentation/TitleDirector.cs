...
namespace BankruptVtuber
{
    ...
    public class TitleDirector : MonoBehaviour
    {
        ...
        void Build()
        {
            ...
            _startDay = UiKit.Image(_start.transform, "NewGameDay", Color.white);
            UiKit.Layout(_startDay.rectTransform, new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(0f, 1f), new Vector2(412f, -10f), new Vector2(180f, 56f));
            ArtSprites.Apply(_startDay, ArtSprites.DayTab, new Color(1f, 0.92f, 0.55f, 0.98f), Color.white);
            _startDay.preserveAspect = true;
            _startDay.raycastTarget = false;
            var startDayT = UiKit.Label(_startDay.transform, "T", "1일차", 18, Palette.Gold, TextAnchor.MiddleCenter, FontStyle.Bold);
            UiKit.Layout(startDayT.rectTransform, new Vector2(0.10f, 0.16f), new Vector2(0.90f, 0.84f), new Vector2(0.5f, 0.5f), Vector2.zero, Vector2.zero);
            _startDay.gameObject.SetActive(false);
            _startHeadline = UiKit.Image(_start.transform, "NewGameHeadline", Color.white);
            UiKit.Layout(_startHeadline.rectTransform, new Vector2(0f, 0f), new Vector2(0f, 0f), new Vector2(0f, 1f), new Vector2(412f, -78f), new Vector2(240f, 88f));
            ArtSprites.Apply(_startHeadline, ArtSprites.HeadlineClip, new Color(0.93f, 0.88f, 0.74f, 0.98f), Color.white);
            _startHeadline.preserveAspect = true;
            _startHeadline.raycastTarget = false;
            var startHeadT = UiKit.Label(_startHeadline.transform, "T", "헤드라인", 18, Palette.Ink, TextAnchor.MiddleCenter, FontStyle.Bold);
            UiKit.Layout(startHeadT.rectTransform, new Vector2(0.10f, 0.16f), new Vector2(0.90f, 0.84f), new Vector2(0.5f, 0.5f), Vector2.zero, Vector2.zero);
            _startHeadline.gameObject.SetActive(false);
            ...
            _continueDay1 = UiKit.Image(_continue.transform, "ContinueDay1", Color.white);
            UiKit.Layout(_continueDay1.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(576f, -8f), new Vector2(180f, 56f));
            ArtSprites.Apply(_continueDay1, ArtSprites.DayTab, new Color(1f, 0.92f, 0.55f, 0.98f), Color.white);
            _continueDay1.preserveAspect = true;
            _continueDay1.raycastTarget = false;
            var day1T = UiKit.Label(_continueDay1.transform, "T", "1일차", 18, Palette.Gold, TextAnchor.MiddleCenter, FontStyle.Bold);
            ...
            _continueDay1.gameObject.SetActive(false);
            ...
            _continueWeekHeadline = UiKit.Image(_continue.transform, "ContinueWeekHeadline", Color.white);
            UiKit.Layout(_continueWeekHeadline.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(576f, -76f), new Vector2(228f, 92f));
            ArtSprites.Apply(_continueWeekHeadline, ArtSprites.HeadlineClip, new Color(0.93f, 0.88f, 0.74f, 0.98f), Color.white);
            _continueWeekHeadline.preserveAspect = true;
            _continueWeekHeadline.raycastTarget = false;
            var weekHeadT = UiKit.Label(_continueWeekHeadline.transform, "T", "헤드라인", 18, Palette.Ink, TextAnchor.MiddleCenter, FontStyle.Bold);
            ...
            _continueLastHeadline = UiKit.Image(_continue.transform, "ContinueLastHeadline", Color.white);
            UiKit.Layout(_continueLastHeadline.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(576f, -76f), new Vector2(228f, 92f));
            ArtSprites.Apply(_continueLastHeadline, ArtSprites.HeadlineClip, new Color(0.93f, 0.88f, 0.74f, 0.98f), Color.white);
            _continueLastHeadline.preserveAspect = true;
            _continueLastHeadline.raycastTarget = false;
            ...
            _continueSponsorPin = UiKit.Image(_continue.transform, "ContinueSponsorPin", Color.white);
            UiKit.Layout(_continueSponsorPin.rectTransform, new Vector2(1f, 0f), new Vector2(1f, 0f), new Vector2(1f, 0f), new Vector2(-476f, 10f), new Vector2(72f, 48f));
            ArtSprites.Apply(_continueSponsorPin, ArtSprites.SponsorCard, Color.white, Color.white);
            _continueSponsorPin.preserveAspect = true;
            _continueSponsorPin.raycastTarget = false;
        ...
        void RefreshContinue()
        {
            ...
            if (_continueWeekStart != null && !_hasSave)
                _continueWeekStart.gameObject.SetActive(false);
            if (_continueDay1 != null && !_hasSave)
                _continueDay1.gameObject.SetActive(false);
            if (_continueWeekHeadline != null && !_hasSave)
                _continueWeekHeadline.gameObject.SetActive(false);
            ...
            if (_startDay != null)
                _startDay.gameObject.SetActive(!_hasSave);
            if (_startHeadline != null)
                _startHeadline.gameObject.SetActive(!_hasSave);
        ...
        void FillContinue(GameRunState peek)
        {
            ...
            if (_continueDay1 != null)
                _continueDay1.gameObject.SetActive(1 == peek.day);
            ...
            if (_continueWeekStart != null)
            {
                ...
                if (_continueWeekHeadline != null)
                    _continueWeekHeadline.gameObject.SetActive(weekStart);
            ...
            if (_continueLastHeadline != null)
                _continueLastHeadline.gameObject.SetActive(last);
            ...
            if (_continueSponsorPin != null)
                _continueSponsorPin.gameObject.SetActive(peek.sponsorMentioned);
