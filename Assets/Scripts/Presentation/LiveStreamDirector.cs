...
namespace BankruptVtuber
{
    public class LiveStreamDirector : MonoBehaviour
    {
        ...
        void Build()
        {
            ...
            _weekMental = UiKit.Image(root, "LiveWeekMental", Color.white);
            UiKit.Layout(_weekMental.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(574f, -268f), new Vector2(104f, 48f));
            ArtSprites.Apply(_weekMental, ArtSprites.MentalNote, new Color(1f, 0.95f, 0.72f, 0.98f), Color.white);
            _weekMental.preserveAspect = true;
            _weekMental.raycastTarget = false;
            var weekMentalT = UiKit.Label(_weekMental.transform, "T", "멘탈", 16, Palette.Ink, TextAnchor.MiddleCenter, FontStyle.Bold);
            UiKit.Layout(weekMentalT.rectTransform, new Vector2(0.10f, 0.16f), new Vector2(0.90f, 0.84f), new Vector2(0.5f, 0.5f), Vector2.zero, Vector2.zero);
            _weekMental.gameObject.SetActive(false);
            ...
            _weekWarn = UiKit.Image(root, "LiveWeekWarn", Color.white);
            UiKit.Layout(_weekWarn.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(690f, -268f), new Vector2(104f, 48f));
            ArtSprites.Apply(_weekWarn, ArtSprites.EventWarn, new Color(0.58f, 0.08f, 0.16f, 0.94f), Color.white);
            _weekWarn.preserveAspect = true;
            _weekWarn.raycastTarget = false;
            var weekWarnT = UiKit.Label(_weekWarn.transform, "T", "경고", 16, Color.white, TextAnchor.MiddleCenter, FontStyle.Bold);
            UiKit.Layout(weekWarnT.rectTransform, new Vector2(0.10f, 0.16f), new Vector2(0.90f, 0.84f), new Vector2(0.5f, 0.5f), Vector2.zero, Vector2.zero);
            _weekWarn.gameObject.SetActive(false);

            _day1Warn = UiKit.Image(root, "LiveDay1Warn", Color.white);
            UiKit.Layout(_day1Warn.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(690f, -268f), new Vector2(104f, 48f));
            ArtSprites.Apply(_day1Warn, ArtSprites.EventWarn, new Color(0.58f, 0.08f, 0.16f, 0.94f), Color.white);
            _day1Warn.preserveAspect = true;
            _day1Warn.raycastTarget = false;
            var day1WarnT = UiKit.Label(_day1Warn.transform, "T", "경고", 16, Color.white, TextAnchor.MiddleCenter, FontStyle.Bold);
            UiKit.Layout(day1WarnT.rectTransform, new Vector2(0.10f, 0.16f), new Vector2(0.90f, 0.84f), new Vector2(0.5f, 0.5f), Vector2.zero, Vector2.zero);
            _day1Warn.gameObject.SetActive(false);
            ...
            _midHeadline = UiKit.Image(root, "LiveMidHeadline", Color.white);
            UiKit.Layout(_midHeadline.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(24f, -272f), new Vector2(168f, 68f));
            ...
            var midHeadT = UiKit.Label(_midHeadline.transform, "T", "헤드라인", 16, Palette.Ink, TextAnchor.MiddleCenter, FontStyle.Bold);
            ...
            _chatRoot = chatPanel;
            _midWarn = UiKit.Image(root, "LiveMidWarn", Color.white);
            UiKit.Layout(_midWarn.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(690f, -268f), new Vector2(104f, 48f));
            ...
            var midWarnT = UiKit.Label(_midWarn.transform, "T", "경고", 16, Color.white, TextAnchor.MiddleCenter, FontStyle.Bold);
            ...
            _midMental = UiKit.Image(root, "LiveMidMental", Color.white);
            UiKit.Layout(_midMental.rectTransform, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(574f, -268f), new Vector2(104f, 48f));
            ...
            var midMentalT = UiKit.Label(_midMental.transform, "T", "멘탈", 16, Palette.Ink, TextAnchor.MiddleCenter, FontStyle.Bold);
        ...
        void ApplyContentShow(ContentShowLook look)
        {
            ...
            if (_midWarn != null)
                _midWarn.gameObject.SetActive(LiveMidWeekDay(GameManager.Instance.Run.day));
            if (_midMental != null)
                _midMental.gameObject.SetActive(LiveMidWeekDay(GameManager.Instance.Run.day));
            if (_midCash != null)
            ...
            if (_day1Warn != null)
                _day1Warn.gameObject.SetActive(1 == GameManager.Instance.Run.day);
            ...
            if (_weekMental != null)
                _weekMental.gameObject.SetActive(LiveWeekStartDay(GameManager.Instance.Run.day));
            if (_weekWarn != null)
                _weekWarn.gameObject.SetActive(LiveWeekStartDay(GameManager.Instance.Run.day));
